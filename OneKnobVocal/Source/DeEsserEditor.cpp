    ...
    :AudioProcessorEditor(&p), mProcessor(p)
{
    ...
    CrossoverFreqKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(mProcessor.apvts, "CROSSOVERFREQ", CrossoverFreqKnob);
    CrossoverFreqKnob.setBounds(0, 165, 120, 20);
