    ...
    :AudioProcessorEditor(&p), mProcessor(p)
{
    ...
    InputGainKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(mProcessor.apvts, "INPUTGAIN", InputGainKnob);
    ...
    MakeUpGainKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(mProcessor.apvts, "MAKEUPGAIN", MakeUpGainKnob);
    ...
    OutputGainKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(mProcessor.apvts, "OUTPUTGAIN", OutputGainKnob);
