    ...
    :AudioProcessorEditor(&p), mProcessor(p)
{
    ...
    PostGainKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_POST_GAIN", PostGainKnob);
    ...
    LowBandGainKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_LOW_BAND_GAIN", LowBandGainKnob);
    ...
    LowBandCutoffKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_LOW_BAND_CUTOFF", LowBandCutoffKnob);
    ...
    LowBandQualityKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_LOW_BAND_QF", LowBandQualityKnob);
    ...
    LowMidBandGainKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_LOWMID_BAND_GAIN", LowMidBandGainKnob);
    ...
    LowMidBandFreqKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_LOWMID_BAND_FREQ", LowMidBandFreqKnob);
    ...
    LowMidBandQualityKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_LOWMID_BAND_QF", LowMidBandQualityKnob);
    ...
    HighMidBandGainKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_HIMID_BAND_GAIN", HighMidBandGainKnob);
    ...
    HighMidBandFreqKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_HIMID_BAND_FREQ", HighMidBandFreqKnob);
    ...
    HighMidBandQualityKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_HIMID_BAND_QF", HighMidBandQualityKnob);
    ...
    HighBandGainKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_HI_BAND_GAIN", HighBandGainKnob);
    ...
    HighBandCutoffKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_HI_BAND_CUTOFF", HighBandCutoffKnob);
    ...
    HighBandQualityKnobAttach = std::make_unique<juce::AudioProcessorValueTreeState::SliderAttachment>(*(mProcessor.ptr_apvts), "EQ_HI_BAND_QF", HighBandQualityKnob);
